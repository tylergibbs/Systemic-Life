...
print("backend")
#googleCalendar
gc = GoogleCalendar('1jl6euiiosnpuv684k2062jmng@group.calendar.google.com')
...
print(gc.preEvents)
#googleSheets
gs = GoogleSheet('addWeeklyQuarterDates', '1jKEN0xOXZuIAMTumUYu8dW18VG3KjcWfmyFSvYfJQrs')
print('same range twice')
print('getRange')
print(gs.getRange('A', 1, 'E', 6))
print('getRangeNum')
print(gs.getRangeNum(1,1,5,6))
gs = GoogleSheet("Sheet1" ,"1wGBzgjCv-I-vz67B6kIp-3aZ4SzWBS0AGJ_nQoKwbmY")
print('add range')
...
gs = GoogleSheet("Actual Budget" ,"1I86sDhp4KS70ciAF7K7ufIZ68TqW0j2h")
print(gs.getCell('A',1))
#toDoist
td = Todoist('782ac2413172c3afe09f70c81a14abd57674c66d')
...
#typefor m     d9676675560379280f2ae301ccac6537c44df100
tf = Typeform('d9676675560379280f2ae301ccac6537c44df100', ['Wie1UR'])
...
print(gcg.getCurrEvent())
#twilio
twl = Twilio("ACe2c4b47f9ff411c9f0b52bb49d264d1c", "86e36a18c9ddee320944bfe3c4a8b338", "+18186964342", "+18188545107")
twl.send("test msg")
...
rpm.addCnct(retValOne("SMS", "test message"), SendSMS("ACe2c4b47f9ff411c9f0b52bb49d264d1c",
